<template>
	<view>
		...
		<view class="lw-padding-wrap lw-common-mt">
			...
			<view class="lw-slider"><slider :value="screen" @changing="sliderChange" step="1" /></view>
