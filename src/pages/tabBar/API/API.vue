    ...
    <view class="lw-container">
        ...
        <template v-else>
            <view class="lw-header-logo">
                <image class="lw-header-image" src="/static/apiIndex.png"></image>
            </view>
            <view class="lw-hello-text">
                <text class="hello-text">以下将演示lw-app接口能力</text>
               <!-- <lw-link class="hello-link" :href="'https://uniapp.dcloud.io/api/'" :text="'https://uniapp.dcloud.io/api/'"
            ...
            <view class="lw-panel" v-for="(item, index) in list" :key="item.id">
                ...
                <view class="lw-panel-c" v-if="item.open">
                    <view class="lw-navigate-item" v-for="(item2,key) in item.pages" :key="key" :url="item.url" @click="goDetailPage(item2.url)">
