<template>
	<view>
		...
		<view class="lw-padding-wrap lw-common-mt">
			...
			<!-- #ifndef MP-ALIPAY -->
			<view class="lw-list lw-common-mt">
				<view class="lw-list-cell">
					<view>
						<view class="lw-label">弹幕内容</view>
					</view>
					<view class="lw-list-cell-db">
						<input v-model="danmuValue" class="lw-input" type="text" placeholder="在此处输入弹幕内容" />
					</view>
				</view>
			</view>
			<view class="lw-btn-v">
...
<script>
	export default {
		...
		onReady: function(res) {
			// #ifndef MP-ALIPAY
			this.videoContext = this.$lw.createVideoContext('myVideo')
			// #endif
		},
		methods: {
			sendDanmu: function() {
