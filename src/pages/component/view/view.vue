	...
	<view>
		...
		<view class="lw-padding-wrap lw-common-mt">
			<view class="lw-hello-text">
				Flex是Flexible Box的缩写，意为“弹性布局”，用来为盒状模型提供最大的灵活性。当设置display: flex后，继续给view等容器组件设置flex-direction: row或column，就可以在该容器内按行或列排布子组件。lw-app默认全局使用flex布局(在App.vue里预设了)。因为flex布局有利于跨更多平台，尤其是采用原生渲染的平台。
			</view>
			
			<view class="lw-title lw-common-mt">
				flex-direction: row
				<text>\n横向布局</text>
			</view>
			<view class="lw-flex lw-row">
				<view class="flex-item lw-bg-red">A</view>
				<view class="flex-item lw-bg-green">B</view>
				<view class="flex-item lw-bg-blue">C</view>
			</view>
			...
			<view class="lw-flex lw-column">
				<view class="flex-item flex-item-V lw-bg-red">A</view>
				<view class="flex-item flex-item-V lw-bg-green">B</view>
				<view class="flex-item flex-item-V lw-bg-blue">C</view>
			</view>
			...
			<view>
				...
				<view class="lw-flex lw-row" style="justify-content: center;">
					<view class="text">横向布局-居中</view>
					<view class="text">横向布局-居中</view>
				</view>
				<view class="lw-flex lw-row" style="justify-content: flex-end;">
				...
				<view class="lw-flex lw-row" style="justify-content: space-between;">
				...
				<view class="lw-flex lw-row" style="flex-wrap: wrap;">
			...
			<view class="lw-flex lw-row">
				...
				<view class="lw-flex lw-column" style="flex: 1;justify-content: space-between;">
