        ...
        <view class="feedback-body feedback-uploader">
            <view class="lw-uploader">
                <view class="lw-uploader-head">
                    <view class="lw-uploader-title">点击预览图片</view>
                    <view class="lw-uploader-info">{{imageList.length}}/8</view>
                </view>
                <view class="lw-uploader-body">
                    <view class="lw-uploader__files">
                        <block v-for="(image,index) in imageList" :key="index">
                            <view class="lw-uploader__file" style="position: relative;">
                                <image class="lw-uploader__img" :src="image" @tap="previewImage(index)"></image>
                                <view class="close-view" @click="close(index)">x</view>
                            </view>
                        </block>
                        <view class="lw-uploader__input-box" v-show="imageList.length < 8">
                        	<view class="lw-uploader__input" @tap="chooseImg"></view>
                        </view>
                    </view>
                </view>
            </view>
